STRINGS = {
    ...
    "btn.find_driver": "🔍 Найти водителя",
    "btn.by_city": "🏙 По городу",
    "btn.by_state": "🗺 По штату",
    "search.ask_name": "Как тебя зовут? Напиши имя и фамилию — проверю по списку сотрудников.\nПример: Ivan Ivanov",
    "search.not_employee": "Тебя нет в списке сотрудников — поиск доступен только сотрудникам. Обратись к администратору.",
    "search.choose_mode": "Искать водителей по городу или по штату?",
    "search.ask_city": "Напиши город (можно с штатом), например: San Jose или San Jose, CA",
    "search.ask_state": "Напиши штат (2 буквы), например: CA",
    "search.city_not_found": "Город не найден в списке. Попробуй ещё раз (например San Jose).",
    "search.state_not_found": "Штат не найден. Напиши 2-буквенный код, например CA.",
    ...
    "weekly.unclear": "🤔 Не понял ответ. Если список актуален — жми «✅ Да» или напиши «Да». Если хочешь очистить — жми «❌ Нет» или напиши «Нет».",
